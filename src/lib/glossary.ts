...
export const CHECK_REQUIREMENTS: Record<string, CheckFieldRequirement[]> = {
  ...
  C1: [{ field: "cookiebotId", label: "Cookiebot ID", reason: "Requires Cookiebot ID. Find it in the Cookiebot admin panel under Settings." }],
  C2: [{ field: "cookiebotId", label: "Cookiebot ID", reason: "Requires Cookiebot ID. Find it in the Cookiebot admin panel under Settings." }],
  C3: [{ field: "cookiebotId", label: "Cookiebot ID", reason: "Requires Cookiebot ID. Find it in the Cookiebot admin panel under Settings." }],
  C4: [{ field: "cookiebotId", label: "Cookiebot ID", reason: "Requires Cookiebot ID. Find it in the Cookiebot admin panel under Settings." }],
  C5: [{ field: "cookiebotId", label: "Cookiebot ID", reason: "Requires Cookiebot ID. Find it in the Cookiebot admin panel under Settings." }],
  G3: [{ field: "cookiebotId", label: "Cookiebot ID", reason: "Requires Cookiebot ID. Find it in the Cookiebot admin panel under Settings." }],
  H1: [{ field: "cookiebotId", label: "Cookiebot ID", reason: "Requires Cookiebot ID. Find it in the Cookiebot admin panel under Settings." }],
  H2: [{ field: "cookiebotId", label: "Cookiebot ID", reason: "Requires Cookiebot ID. Find it in the Cookiebot admin panel under Settings." }],
