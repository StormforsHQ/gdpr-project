...
interface McpServer {
  ...
  auth: string;
  description: string;
  capabilities: { name: string; useful: boolean | "partial"; detail: string }[];
  notes?: string[];
  setupHint?: string;
}
...
const MCP_SERVERS: McpServer[] = [
  ...
  },
  {
    ...
    notes: [
      ...
      "Stats API: https://consent.cookiebot.com/api/v1/{apikey}/json/domaingroup/{serial}/domain/{domain}/consent/stats",
